...
final class TransactionTest extends TestCase
{
    ...
    public function testEditingKeepsIdentityAccountAssetRawLabelAndProvenance(): void
    {
        ...
        $edited = $original->edit(
            ...
            counterparty: 'Carrefour', note: 'Corrigé', paymentMethod: null, mcc: null,
        ...
        self::assertSame($original->rawLabel, $edited->rawLabel);
    ...
    private function transaction(string $amount, TransactionNature $nature): Transaction
    {
        $now = new \DateTimeImmutable('2026-03-14T09:12:04+00:00');
