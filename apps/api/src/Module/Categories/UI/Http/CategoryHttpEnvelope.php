...
/**
 * The request and response envelope shared by the category endpoints: the media
 * type, the size ceiling, the JSON syntax, the identifier shape and the RFC 9457
 * document. Each answers its own status, so they stay together rather than being
 * copied into every controller that serves a category.
 */
final readonly class CategoryHttpEnvelope
{
    public const string TYPE_OPERATION_REFUSED = '/problems/category-operation-refused';
